...
#ifndef __GDIPENUMS_C_H
#define __GDIPENUMS_C_H
...
#define ObjectTypeIsValid(type) ((type >= ObjectTypeMin) && (type <= ObjectTypeMax))
...
#define GDIP_WMF_RECORD_TO_EMFPLUS(n)   ((enum EmfPlusRecordType)((n) | GDIP_WMF_RECORD_BASE))
