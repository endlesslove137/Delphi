...
procedure Register;
begin
  RegisterComponents('Samples', [TZmmColorButton]);
end;
{ TZmmColorButton }
//*** 构造函数 *****************************************************
constructor TZmmColorButton.Create(AOwner: TComponent);
begin
...
//*** 析构函数 *************************************************
destructor TZmmColorButton.Destroy;
begin
  FCanvas.Free;
  inherited Destroy;
end;
...
procedure TZmmColorButton.CreateParams(var Params: TCreateParams);
begin
...
//*** 属性写方法 ************************************************
procedure TZmmColorButton.SetColor(Value:TColor);
begin
  FColor:=Value;
  Invalidate;
end;
...
//*** 设置按钮状态***********************************************
procedure TZmmColorButton.SetButtonStyle(ADefault: Boolean);
begin
...
//*** 绘制按钮 ***************************************************
procedure TZmmColorButton.CNDrawItem(var Message: TWMDrawItem);
var
