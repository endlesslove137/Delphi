...
//作为buf的加密与解密不会写入和读取长度值
function EncryptBuf(const Src; const SrcSize: Integer; const Key: string;
  var Dest; const DestSize: Integer; KeyBit: TKeyBit = kb128): Integer;
function DecryptBuf(const Src; const SrcSize: Integer; const Key: string;
  var Dest; const DestSize: Integer; KeyBit: TKeyBit = kb128): Integer;
...
function EncryptBuf(const Src; const SrcSize: Integer; const Key: string;
  var Dest; const DestSize: Integer; KeyBit: TKeyBit): Integer;
var
  SS, DS: TMemoryStream;
  AESKey128: TAESKey128;
  AESKey192: TAESKey192;
