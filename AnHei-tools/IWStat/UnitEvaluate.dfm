inherited EvaluateFrm: TEvaluateFrm
  DesignLeft = 8
  DesignTop = -22
  inherited IWRegionClient: TIWRegion
    inherited IWRegion1: TIWRegion
      object IWRegion2: TIWRegion
        ...
        object twdtslctrSDate: TTIWDateSelector
          Tag = 150
          Left = 91
          Top = 34
          Width = 171
        ...
        object twdtslctrEDate: TTIWDateSelector
          Tag = 151
          Left = 339
          Top = 34
          Width = 171
        ...
        object cbbCvalue: TIWComboBox
          ...
          ItemIndex = -1
          Sorted = False
          FriendlyName = 'cbbCvalue'
        end
        object iwlblCvalue: TIWLabel
          Left = 262
          Top = 11
          Width = 93
          Height = 21
          ...
          ConvertSpaces = False
          HasTabOrder = False
          FriendlyName = 'iwlblCvalue'
          Caption = #27963#21160#21517#31216#65306
          RawText = False
        end
        object iwlblCType: TIWLabel
          Left = 15
          Top = 11
          Width = 93
          Height = 21
      ...
      object IWRegion3: TIWRegion
        ...
        ZIndex = 1000
        Splitter = False
        object twdvwbgrdmessage: TTIWAdvWebGrid
          Left = 193
          Top = 0
          Width = 666
          Height = 522
          ...
          UseFullHeight = True
          UseFullWidth = True
          OnButtonClick = twdvwbgrdmessageButtonClick
        ...
        object twdvwbgrdPersent: TTIWAdvWebGrid
          Left = 0
          Top = 0
          Width = 193
          Height = 522
  ...
  inherited IWRegionChangePass: TIWRegion
    ...
    ExplicitLeft = 609
    ExplicitTop = 256
    inherited TIWGradientChangPass: TTIWGradientLabel
      ExplicitLeft = 3
    end
    inherited IWlabChangePassTitle: TIWLabel
      Left = 99
      Top = 3
      ExplicitLeft = 99
      ExplicitTop = 3
