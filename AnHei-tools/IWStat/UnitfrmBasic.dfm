object IWFormBasic: TIWFormBasic
  Left = 0
  Top = 0
  Width = 1024
  Height = 700
  ...
  DesignLeft = 8
  DesignTop = 8
  object IWRegionClient: TIWRegion
    Left = 165
    Top = 75
    Width = 859
    Height = 625
    ...
    object IWRegion4: TIWRegion
      ...
      DesignSize = (
        859
        30)
      object TIWGradientNavigation: TTIWGradientLabel
        Left = 0
        Top = 0
        Width = 859
        Height = 30
      ...
      object IWlabOpenServerTime: TIWLabel
        Left = 652
        Top = 9
        Width = 205
        Height = 19
        ...
        HasTabOrder = False
        AutoSize = False
        FriendlyName = 'IWlabOpenServerTime'
        RawText = False
      end
      object IWlabcurServer: TIWLabel
        Left = 4
        Top = 3
        Width = 0
        Height = 0
        ...
        ConvertSpaces = False
        HasTabOrder = False
        FriendlyName = 'IWlabcurServer'
        RawText = False
      end
    end
  end
  object IWNavBarRegion: TIWRegion
    Left = 0
    Top = 75
    Width = 165
    Height = 625
    ...
    ZIndex = 1000
    Splitter = False
    object TIWBasicSideNavBar1: TTIWExchangeBar
      Left = 0
      Top = 0
      Width = 163
      Height = 625
      ...
      StyleRenderOptions.RenderAbsolute = True
      VisiblePanels = 2
      Button.ActiveColor = clWebYELLOW
      Button.ActiveColorTo = clWebGOLD
      Button.ActiveHoverColorTo = clWebYELLOWGREEN
      Button.BackColor = clWebLIGHTSALMON
      Button.BackColorTo = 4749293
      Button.Font.Color = clNone
      Button.Font.FontName = #23435#20307
      Button.Font.Size = 11
      Button.Font.Style = [fsBold]
      Button.ForeColor = clNone
      Button.GradientDirection = gdHorizontal
      Button.HoverColorTo = clWebSANDYBROWN
      Button.SelectColor = clWebLIGHTSALMON
      Button.SelectColorTo = 4749293
      Font.Color = clNone
      ...
      Splitter.BackColor = 8694014
      Splitter.BackColorTo = 4146101
      OnItemClick = TIWBasicSideNavBar1ItemClick
      ExplicitLeft = -1
      ExplicitTop = -2
      ExplicitWidth = 160
    end
    object TIWGradientBarRight: TTIWGradientLabel
      Left = 163
      Top = 0
      Width = 2
      Height = 625
  ...
  object IWAppTitleRegion: TIWRegion
    Left = 0
    Top = 0
    Width = 1024
    Height = 75
    ...
    object TIWGradientTitleTop: TTIWGradientLabel
      Left = 0
      Top = 73
      Width = 1024
      Height = 2
    ...
    object IWcBoxZJHTServers: TIWComboBox
      Left = 491
      Top = 32
      Width = 176
      Height = 21
      ...
      ScriptEvents = <>
      OnChange = IWcBoxZJHTServersChange
      UseSize = True
      Style = stNormal
      ...
      ItemIndex = -1
      Sorted = False
      FriendlyName = 'IWcBoxZJHTServers'
    end
    object IWlabZJHTTitle: TIWLabel
      Left = 182
      Top = 18
      Width = 123
      Height = 32
      ...
      ConvertSpaces = False
      HasTabOrder = False
      FriendlyName = 'IWlabZJHTTitle'
      Caption = #25968#25454#32479#35745
      RawText = False
    end
    object IWlabCurDate: TIWLabel
      Left = 729
      Top = 39
      Width = 103
      Height = 21
      ...
      ConvertSpaces = False
      HasTabOrder = False
      FriendlyName = 'IWlabCurDate'
      Caption = #20170#26085' %s %s'
      RawText = False
    end
    object IWlabCurUser: TIWLabel
      Left = 729
      Top = 13
      Width = 83
      Height = 21
      ...
      ConvertSpaces = False
      HasTabOrder = False
      FriendlyName = 'IWlabCurUser'
      Caption = #24744#22909#65292'%s'
      RawText = False
    end
    object IWbtnCloseApp: TIWButton
      Left = 935
      Top = 36
      Width = 75
      Height = 25
      Cursor = crAuto
      Hint = #22914#26524#22312#32593#21543#20250#38750#20010#20154#30005#33041#65292#20351#29992#21518#35831#28857#20987#8220#23433#20840#36864#20986#8221#65281#21542#21017#20250#27844#23494#65281
      Anchors = [akRight, akBottom]
      IW50Hint = False
      ParentShowHint = False
      ShowHint = True
      ...
      StyleRenderOptions.RenderStatus = True
      StyleRenderOptions.RenderAbsolute = True
      Caption = #23433#20840#36864#20986
      DoSubmitValidation = True
      Color = clBtnFace
      Font.Color = clNone
      Font.Size = 10
      Font.Style = []
      FriendlyName = 'IWbtnCloseApp'
      ScriptEvents = <>
      TabOrder = 3
      OnClick = IWbtnCloseAppClick
    end
    object IWbtnChangePass: TIWButton
      Left = 935
      Top = 5
      Width = 75
      Height = 25
      ...
      Font.Size = 10
      Font.Style = []
      FriendlyName = 'IWbtnChangePass'
      ScriptEvents = <>
      TabOrder = 9
      OnClick = IWbtnChangePassClick
    end
    object IWcBoxZJHTSpList: TIWComboBox
      Left = 288
      Top = 32
      Width = 176
      Height = 21
      ...
      RequireSelection = True
      ScriptEvents = <>
      OnChange = IWcBoxZJHTSpListChange
      UseSize = True
      Style = stNormal
      ButtonColor = clBtnFace
      DoSubmitValidation = True
    ...
    object IWLabelApp: TIWLabel
      ...
      ConvertSpaces = False
      HasTabOrder = False
      FriendlyName = 'IWLabelApp'
      Caption = #32593#21543' '#25110#32773' '#38750#31169#20154#30005#33041#65292#20351#29992#21518#35831#28857#20987#8220#23433#20840#36864#20986#8221#65281#21542#21017#20250#27844#23494#65281
      RawText = False
    end
    object IWPTServers: TIWLabel
      Left = 290
      Top = 13
      Width = 170
      Height = 21
      ...
      ConvertSpaces = False
      HasTabOrder = False
      FriendlyName = 'IWLHZSServers'
      Caption = #36873#25321#36816#33829#21830#21450#36816#33829#24179#21488
      RawText = False
    end
    object IWLHZSServers: TIWLabel
      Left = 491
      Top = 13
      Width = 153
      Height = 21
      ...
      Caption = #36873#25321#35813#24179#21488#30340#26381#21153#22120
      RawText = False
    end
  end
  object IWRegionChangePass: TIWRegion
    Left = 253
    Top = 208
    Width = 260
    Height = 228
    ...
    ZIndex = 1000
    Splitter = False
    object TIWGradientChangPass: TTIWGradientLabel
      Left = 1
      Top = 1
      Width = 258
      Height = 30
    ...
    object IWlabChangePassTitle: TIWLabel
      Left = 91
      Top = 7
      Width = 74
      Height = 21
      ...
      ConvertSpaces = False
      HasTabOrder = False
      FriendlyName = 'IWlabChangePassTitle'
      Caption = #20462#25913#23494#30721
      RawText = False
    end
    object IWLabelCPOldPass: TIWLabel
      Left = 32
      Top = 51
      Width = 74
      Height = 21
      ...
      ConvertSpaces = False
      HasTabOrder = False
      FriendlyName = 'IWLabelCPOldPass'
      Caption = #21407#23494#30721#65306
      RawText = False
    end
    object IWedtCPOldPass: TIWEdit
      Left = 104
      Top = 48
      Width = 130
      Height = 21
    ...
    object IWbtnCPOK: TIWButton
      ...
      Font.Size = 10
      Font.Style = []
      FriendlyName = 'IWbtnCPOK'
      ScriptEvents = <>
      TabOrder = 6
      OnClick = IWbtnCPOKClick
    end
    object IWbtnCPCancel: TIWButton
      Left = 143
      Top = 184
      Width = 75
      Height = 25
      ...
      Font.Size = 10
      Font.Style = []
      FriendlyName = 'IWbtnCPCancel'
      ScriptEvents = <>
      TabOrder = 7
      OnClick = IWbtnCPCancelClick
    end
    object IWLabelCPNewPass: TIWLabel
      Left = 32
      Top = 91
      Width = 74
      Height = 21
      ...
      ConvertSpaces = False
      HasTabOrder = False
      FriendlyName = 'IWLabelCPNewPass'
      Caption = #26032#23494#30721#65306
      RawText = False
    end
    object IWlabCPVerifyPass: TIWLabel
      Left = 32
      Top = 130
      Width = 93
      Height = 21
      ...
      ConvertSpaces = False
      HasTabOrder = False
      FriendlyName = 'IWlabCPVerifyPass'
      Caption = #30830#35748#23494#30721#65306
      RawText = False
    end
    object IWedtCPVerifyPass: TIWEdit
      Left = 104
      Top = 128
      Width = 130
      Height = 21
      ...
      Font.Size = 10
      Font.Style = []
      FriendlyName = 'IWedtCPVerifyPass'
      MaxLength = 0
      ReadOnly = False
      Required = False
      ScriptEvents = <>
