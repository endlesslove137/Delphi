...
type
  TStatToolButton = ({1}tbBasicConfig,tbSetUserPop,tbOverview,tbOnlineAndPay,tbAllOnlineAndPay,
                    ...
                    {110}tbVaseries, tbIWStatList , tbEvaluate
                     );
...
uses ServerController, ConfigINI, UnitfrmOnlineCount, UnitfrmRole,
  ...
  UnitfrmVaseries, UnitfrmIWStatList, UnitEvaluate;
...
begin
  ...
  tbHumMapCount,tbCopyTrack,tbHumdieMap,tbHumDropItems, tbFirstConsume, tbConsumeLevel,tbMonKillhum,tbMonStrength,tbGlobalUserYuanbao,tbEvaluate];
...
begin
  ...
  case TStatToolButton(UserSession.curTB) of
    ...
    tbEvaluate:
    begin
      with Move(TEvaluateFrm) as TEvaluateFrm do
      begin
        Show;
      end;
    end;
