...
type
  TIWfrmDataEngine = class(TIWFormBasic)
    IWRegion2: TIWRegion;
    IWRegion6: TIWRegion;
...
var
  IWfrmDataEngine: TIWfrmDataEngine;
...
procedure TIWfrmDataEngine.IWAppFormCreate(Sender: TObject);
var
...
procedure TIWfrmDataEngine.IWButton1Click(Sender: TObject);
begin
  inherited;
  SendGSMessage(MSS_GET_CURR_PROCESS_MEM_USED);
end;

procedure TIWfrmDataEngine.IWCheckBox1Click(Sender: TObject);
var
  I: Integer;
begin
  inherited;
...
procedure TIWfrmDataEngine.IWTimerResultTimer(Sender: TObject);
var
  StrResult: string;
...
procedure TIWfrmDataEngine.SendGSMessage(const MessageID: Integer);
var
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              case MessageID of
                MSS_GET_CURR_PROCESS_MEM_USED:
                begin
                  m_Server.SendCurProcessMemUsed(SID);
                end;
              end;
              IWTimerResult.Enabled := False;
...
initialization
  RegisterClass(TIWfrmDataEngine);
end.
