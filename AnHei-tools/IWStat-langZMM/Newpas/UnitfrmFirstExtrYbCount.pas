    ...
    begin
      ...
      begin
        ...
        try
          ...
          begin
            RowCount := nCount + 1;
            cells[1,nCount] := IntToStr(FieldByName('Para1').AsInteger);  //数量
            cells[2,nCount] := IntToStr(FieldByName('Para2').AsInteger); //等级
            cells[3,nCount] := IntToStr(FieldByName('iCount').AsInteger); //人数
            Inc(nCount);
            Next;
          end;
        finally
